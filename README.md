...
## Setup Doxygen file to relevant subfolders

Update the doxyfile configuration according to the need and execute it via  `doxygen <config-file> `, Then view generated documentation on the default browser
